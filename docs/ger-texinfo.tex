...
%-
%-  modified for german umlauts (ISO 8859-1) and german language
%-  by Martin Husemann, martin@euterpe.owl.de, Thu Mar 17 16:09:32 1994
%-
...
\global\advance \chapno by 1 \message{Kapitel \the\chapno}%
\chapmacro {#1}{\the\chapno}%
\gdef\thissection{#1}%
\gdef\thischaptername{#1}%
% We don't substitute the actual chapter name into \thischapter
% because we don't want its macros evaluated now.
\xdef\thischapter{Kapitel \the\chapno: \noexpand\thischaptername}%
{\chapternofonts%
...
% Normal (long) toc.
\outer\def\contents{%
   \startcontents{Inhaltsverzeichnis}%
      \input \jobname.toc
   \endgroup
   \vfill \eject
}
...
%\hsize = 6.5in
\newdimen\defaultparindent \defaultparindent = 0pt
\parindent = \defaultparindent
