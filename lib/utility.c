 ...
 *
 * PARAMETER
 *   size_t s - Groesse des gewuenschten Bereichs.
 *
 * RESULT
 *   void * - Zeiger auf den allozierten Bereich.
 *
 * BUGS
 *
 */
 ...
 *
 * DESCRIPTION
 *   Dies ist ein Wrapper fuer die strdup-Funktion.
 *
 * PARAMETER
 *   char *s - zu kopierender String.
 *
 * RESULT
...
#endif
#undef	TZNAME_MISSING		/* needed on ultrix and maybe others */
