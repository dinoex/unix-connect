...
/* apc_a2b versucht, in message den Binaer-Teil zu konvertieren.
   ...
   andernfalls gibt es die Anzahl der Bytes zwischen dem
   Beginn der Nachricht (message) und den Beginn des kon-
   vertierten Binaer-Teils (fuer KOM: header).
   Der Wert in *msglen wird angepasst.
 */
